# PiMKRHAT + MKR ENV python code example for humidity & temperature sensor
# visit www.hwhardsoft.de for more information
#
# (based on code for HTS221_I2CS I2C Mini Module available from ControlEverything.com)
