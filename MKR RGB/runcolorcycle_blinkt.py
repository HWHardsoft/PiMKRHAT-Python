...
NUM_LED = 84
MOSI = 17  # Hardware SPI uses BCM 10 & 11. Change these values for bit bang mode
SCLK = 12  # e.g. MOSI = 23, SCLK = 24 for Pimoroni Phat Beat or Blinkt!
...
MY_CYCLE = colorschemes.Rainbow(num_led=NUM_LED, pause_value=0, order='rgb',
                                num_steps_per_cycle=10, num_cycles=5, mosi=MOSI, sclk=SCLK)
MY_CYCLE.start()
